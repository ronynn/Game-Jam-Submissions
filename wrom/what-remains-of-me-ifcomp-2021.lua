...
-- author: r01nx
-- desc:   An exploration of my old neighbourhood, in search for an objective in life.
-- script: lua
...
--engine variables
ver="What remains of me: An exploration of my old room circa 2010."
...
function eventIntro()
 txt("You are me. You are in my room. You watched TV for 11 hours yesterday and now you believe you have been living with no objective. Find an objective, or take the train that takes you there",14)
end
...
function eventDescribe(r)
 if r==1 then
	...
	elseif r==11 then
	 txt "You are at the school. There is a giant frog threatening people for some reason. It's making all kinds of noises."
	elseif r==12 then
...
function eventUse(i)
 if i==1 and room==12 then
	...
	elseif i==8 and room==14 then
	 ...
	 txt "And I hope you enjoyed this journey. An expansion of this world with more interactions is available."
		win()
	else
  return 1
	end
...
function eventOpen(i)
 if i==1 and i==5  and i==7 then
	 examine(i) --you even can call function to not repeat the same code as in examine
	else
	 return 1
	end
end
